                        ...
                        <TrackVisibility>
                            {({ isVisible }) =>
                                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                                    ...
                                    <h1>{`Hi! I&apos;m Cameron`} <span className="txt-rotate" data-period="1000" data-rotate={`[ "Web Developer", "Software Engineer", "UI/UX Designer" ]`}><span className="wrap">{text}</span></span></h1>
